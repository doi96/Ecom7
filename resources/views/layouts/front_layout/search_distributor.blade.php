    ...
    <form action="{{ route('user.distributor.search') }}" method="POST">@csrf
        <div class="form-group">
            <div class="input-group mb-3">
                <input type="text" class="form-control" name="search" placeholder="{{__('label.searchdistributor')}}" onfocus="this.placeholder = ''" onblur="this.placeholder = '{{__('label.searchdistributor')}}'">
